<script lang="ts">
  ...
  import { z } from 'zod';
  import { EditorPreferencesSchema } from '../config/EditorPreferencesForm.schema';
  import FormField from './FormField.svelte';
  import { userEditorPreferencesState, Theme, Cursor, FontFamily, Language } from '$features/Editor';
